 ...
 */
public class Car extends Moveable implements ISteerable, IColorable, IDrawable {
    private int width;
    private int length;
    ...
    public void steerLeft(){
        if(this.getSteeringDirection() > -40 ){
            this.setSteeringDirection(this.getSteeringDirection()-1);
        }
    }
    ...
    public void draw(Graphics g) {
        ...
        g.fillRect(x, y, getWidth(), getLength());
    }
}
